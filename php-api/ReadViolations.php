...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if ($_SESSION['isAdmin']) {
        ...
        if ($violationYear) {
            $whereClauses[] = "YEAR(ViolationRecord.ViolationDate) = :ViolationYear";
        ...
        $sql = 'SELECT Students.StudentID, Students.StudentName, Students.Year, Students.ProgramID, 
		               ...
		               COUNT(ViolationRecord.ViolationID) AS ViolationCount,
		               ...
		               MAX(ViolationRecord.ViolationDate) AS LatestViolationDate
		        FROM Students
        ...
        // Order by latest violation date (descending)
        $sql .= ' ORDER BY LatestViolationDate DESC';
