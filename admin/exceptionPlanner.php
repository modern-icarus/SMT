...
<head>
    ...
    <title>Exception Days - Control Panel</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="header">
            <div class="blue__bar">
                <h2>Control Panel - Exception Days</h2>
            </div>
        ...
        <div class="row mx-3 g-5 mt-2">
            ...
            <div class="col-12 col-md-8 mx-auto">
                <div class="table-area overflow-auto card shadow-lg border-0 rounded-5">
